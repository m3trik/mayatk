...
class TestStaggerKeyframes(MayaTkTestCase):
    """Test suite for stagger_keyframes functionality."""
    ...
    def test_sequential_stagger_gap(self):
        ...
        StaggerKeys.stagger_keyframes(self.objects, spacing=5)
    ...
    def test_sequential_stagger_overlap(self):
        ...
        StaggerKeys.stagger_keyframes(self.objects, spacing=-2)
    ...
    def test_interval_stagger(self):
        ...
        StaggerKeys.stagger_keyframes(self.objects, spacing=20, use_intervals=True)
    ...
    def test_group_overlapping(self):
        ...
        StaggerKeys.stagger_keyframes(self.objects, spacing=5, group_overlapping=True)
    ...
    def test_stagger_invert(self):
        ...
        # Cube 2: 15-25 (10 + 5)
        # Cube 1: 30-40 (25 + 5)
        StaggerKeys.stagger_keyframes(self.objects, spacing=5, invert=True)
    ...
    def test_stagger_ignore_attribute(self):
        ...
        StaggerKeys.stagger_keyframes(self.objects, spacing=5, ignore="translateY")
    ...
    def test_stagger_start_frame_override(self):
        ...
        # Start at frame 100
        StaggerKeys.stagger_keyframes(self.objects, spacing=5, start_frame=100)
    ...
    def test_stagger_percentage_spacing(self):
        ...
        StaggerKeys.stagger_keyframes(self.objects, spacing=0.5)
    ...
    def test_stagger_no_keys(self):
        ...
        # Cube 2: 15-25 (10 + 5)
        StaggerKeys.stagger_keyframes(objects, spacing=5)
...
class TestStaggerSplitStatic(MayaTkTestCase):
    """Tests for split_static functionality in stagger_keyframes."""
