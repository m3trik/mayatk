...
Imports the model, then reads the JSON material manifest to recreate
each Maya shader on the Toolbag side (base color / normal / roughness
texture slots populated from disk paths recorded at export time)."""
