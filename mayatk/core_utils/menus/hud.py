...
class HudUi:
    def __new__(cls):
        ...
        ui_filepath = os.path.join(os.path.dirname(__file__), f"hud.ui")
        ui = UiManager.get_ui(ui_source=ui_filepath, slot_source=HudSlots)
        return ui
...
if __name__ == "__main__":
    HudUi().show(pos="screen", app_exec=True)
