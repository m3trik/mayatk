...
class Core():
	...
	def appendMayaPaths(maya_version=2023):
		...
		os.environ["PATH"] = os.path.join(maya_install_path, "bin") + ";" + os.environ["PATH"]
		...
		sys.path.append(os.path.join(maya_install_path, "Python", maya_version, "lib", "lib-tk"))
		sys.path.append(os.path.join(maya_install_path, "Python", maya_version, "lib", "plat-win"))
		sys.path.append(os.path.join(maya_install_path, "Python", maya_version, "lib", "site-packages"))
		sys.path.append(os.path.join(maya_install_path, "devkit", "other", "pymel", "extras", "modules"))
		sys.path.append(os.path.join(maya_install_path, "devkit", "other", "pymel", "extras", "completion"))
